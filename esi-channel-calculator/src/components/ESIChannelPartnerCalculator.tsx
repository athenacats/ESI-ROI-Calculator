    ...
    >
            ...
            <div key={idx} className="grid grid-cols-12 gap-3 items-end">
              ...
              <div className="col-span-12 sm:col-span-4">
                ...
                <input
                  ...
                  step={100}
                  onChange={(e) =>
                    updateTier(idx, "amount", numberFromInput(e.target.value))
                  }
                  className="
                    w-full rounded-xl 
                    bg-[#1d2023] border border-[var(--line)]
      ...
      >
        ...
        >
          ...
          <div className="grid grid-cols-5 gap-4 text-sm text-white">
            ...
            <div className="text-right">
              {Number.isNaN(customUpliftPct) ? "—" : pctFmt(customUpliftPct)}
              <div className="text-xs text-[var(--muted)]">
      ...
      >
        ...
        <ul className="list-disc pl-6 text-sm text-white space-y-2">
          ...
          <li className="">
            Illustrative only. Results depend on client mix, eligibility, and
            final agreements.
          </li>
        </ul>
      </section>
      ...
      <footer className="mt-6 text-xs text-[var(--muted)] text-center">
        Disclaimer: This calculator is for illustration purposes only. It is not
        a quote or guarantee. All figures are annual & pre-tax.
      </footer>
    </div>
  );
}
